...
; ripped straight from gps.
; TODO figure out how it actually works, reimplement the stripe image changes
; instead of jsl2rtsing the stripe image update portion
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
change_map16:
	; if called in 16 bit mode, this reads/writes the 'run the game' flag
	; todo is this a vblank hazard?
	LDA $0F : PHA
	PHP
	PHY
	PHX
...
.done
%set_free_finish("bank4", change_map16_done)
